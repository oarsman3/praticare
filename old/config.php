...
define('DB_NAME',     'usr_web202_1');
define('DB_USERNAME', 'web202');
define('DB_PASSWORD', 'messico1');

// Per i messaggi automatici di posta elettronica
define('MAIL_FROM',       'santabrera@zapito.it');           // Indirizzo del mittente
define('MAIL_FROM_NAME',  'gas santabrera');                   // Nome del mittente
define('MAIL_REPLY',      'non-rispondere@zapito.it');     // Indirizzo per le risposte
...
define('MAIL_HOST', "smtp.gmail.com"); // Server SMTP (anche più di uno separati da ;)
define('MAIL_PORT', 465);                 // Porta del server SMTP (anche in coda all'host separata da :)
define('MAIL_SMTP_AUTH', true);         // Autenticazione SMTP 
define('MAIL_USERNAME', 'ftripic@gmail.com');     // SMTP username  
define('MAIL_PASSWORD', 'messico1');     // SMTP password
