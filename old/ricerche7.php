...
<?php
	...
	define('FULL_DATA',6);
	define('SQL_STD_FROM',	'FROM (Anagrafica_Contatto INNER JOIN Anagrafica_Referente ON Anagrafica_Contatto.ID_Contatto = ' .
							'Anagrafica_Referente.FK_Contatto) LEFT JOIN (Lista_Attivita_Adesioni RIGHT JOIN (Adesioni RIGHT JOIN ' .
							'Bambini ON Adesioni.FK_Bambino = Bambini.ID_Bambino) ON Lista_Attivita_Adesioni.ID_Attivita = Adesioni.FK_Attivita) ' .
							'ON Anagrafica_Contatto.ID_Contatto = Bambini.FK_Contatto ');
	...
	case 'FULL_DATA':
		...
		"Anagrafica_Referente.CAP, Anagrafica_Referente.Comune, Anagrafica_Referente.Note, Bambini.Cognome, Bambini.Nome, " .
