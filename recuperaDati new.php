<?php
	...
	elseif ($TipoDato=="DATI_REFERENTE") {
		...
		while($arow = mysqli_fetch_array($result)) {
			...
			$refInt[$numInt]['Stato'] 					= $arow['Stato'];
			$refInt[$numInt]['Note'] 					= $arow['Note'];
		...
		while($ptrInt<$numInt) {
			...
			$refInt[$ptrInt]['Nome_Attivita'] = mysqli_fetch_array($result);	// nome attivita referente
			$ptrInt++;
		}	   
...
/*		
		array_push($jarr, array('P_IVA'					=> $row['P_IVA'],
								...
								'Nome_Attivita'			=> $aarow['Nome_Attivita_Interessamento'],
								'Num_Partecipanti'		=> $arow['Num_Partecipanti'],
								'Stato_Interessamento'	=> $arow['Stato'],
								'Note_Interessamento'	=> $arow['Note']));
*/								
		array_push($jarr, array('P_IVA'					=> $row['P_IVA'],
								'NR_TEL'				=> $row['NR_TEL'],
								'E_MAIL'				=> $row['E_MAIL'],
								...
								'Comune'				=> $row['Comune'],
								'Note_Ref'				=> $row['Note_Ref'],
								'lista_interessamenti'	=> array($refInt)));
	}
